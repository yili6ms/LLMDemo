...
def main():
    ...
    train_parser.add_argument('--input', type=str, default='data/tiny.txt', help='Input text file')
    train_parser.add_argument('--output', type=str, default='tok/bpe.json', help='Output tokenizer file')
    ...
    encode_parser.add_argument('--tokenizer', type=str, default='tok/bpe.json', help='Tokenizer file')
    ...
    decode_parser.add_argument('--tokenizer', type=str, default='tok/bpe.json', help='Tokenizer file')
    decode_parser.add_argument('tokens', nargs='+', type=int, help='Token IDs to decode')
