...
class TestTrainingPipeline:
    ...
    def test_training_with_evaluation(self):
        ...
        for step in range(3):
            ...
            # Evaluation
            val_metrics = evaluate(model, val_data, batch_size, seq_len, device, num_batches=5)
    ...
    def test_checkpoint_save_load_integration(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Save checkpoint
            save_checkpoint(model, optimizer, scheduler, step=3, val_loss=loss, 
...
class TestEndToEndWorkflow:
    ...
    def test_complete_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            save_checkpoint(
                model, optimizer, MockScheduler(),
                step=10, val_loss=loss, config=config, path=model_path
            )
