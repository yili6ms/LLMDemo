...
class TestTinyGPT:
    ...
    def test_init(self):
        ...
        model = TinyGPT(vocab_size=1000, d_model=128, n_layers=2, n_heads=4)
    ...
    def test_generate(self):
        ...
        model = TinyGPT(vocab_size=100, d_model=64, n_layers=1, n_heads=2)
    ...
    def test_weight_tying(self):
        ...
        model = TinyGPT(
            vocab_size=100, d_model=64, n_layers=1, n_heads=2, tie_weights=True
        )
